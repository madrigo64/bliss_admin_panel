...
Известные Баги
=================
1)Проблема наблюдается у тех кто использует лицензионный ключ на сервере
...
2)На карте Такистан не верно отображаются координаты. Исправлений не будет, так как сама карта сделанна со сдвигом по координатам.
