...
// по умолчанию вход в админ панель как суперадмин логи superadmin  пароль 123456
...
define('SITENAME', 'Админ панель для блисс сервера');  //пока не работает, игорим данную строку
...
define('MAX_LENGTH_PLAYER_NAME', 20);  // максимальная допустимая длинна имени игрока (работает только при отображении игроков через rcon онлайн)
